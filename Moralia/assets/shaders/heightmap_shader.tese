...
layout(location = 0) out float normalizedYPosition;
...
void main()
{
    ...
    normalizedYPosition = texture(uHeightmapTextures[uTextureIndex], texCoord).y;
    ...
    gl_Position = uProjectionView * uModelMatrix * p;
}